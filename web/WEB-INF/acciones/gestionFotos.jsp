<%-- 
    Document   : gestionFotos
    Created on : 01-feb-2015, 14:56:56
    Author     : Alejandro
--%>
        ...
        <div class="centercolumn">
            ...
            <div id="maincontent">
                <div id="content" class="full">
                    <h2 class="underline">Gestionar fotos</h2>
                    <%
                     List<Imagen> listaImagen;
                     listaImagen = (List<Imagen>) ModeloImagen.getidInmueble(request.getAttribute("idInmuebleFotos").toString());
                     String idInmueble=request.getAttribute("idInmuebleFotos").toString();
                     String rutaMal;
                     String[] rutas;
                     String rutaBien;
                     for (Imagen p : listaImagen) {
                                if(listaImagen.size()==0){
                                    rutaBien="";
                                }else{
                                    rutaMal=p.getRuta().toString();
                                    rutas=rutaMal.split("/");
                                    rutaBien="images/"+rutas[1].toString()+"/"+rutas[2].toString()+"/"+rutas[3].toString();
                                }
                        %>
                        <div class="BorrarFila">
                            <img class="gestion" src="<%= rutaBien %>" alt="" />
                            <a class="enlaceBorrar" href="control?target=inmueble&op=eliminarFoto&action=op&idFoto=<%= p.getId()%>&idInmueble=<%= idInmueble %>">Borrar</a>
                            <br>
                        </div>
                        <%
                            }
